          <!-- -------------- Sidebar Menu  -------------- -->
            <ul class="nav sidebar-menu">
                ...
                <li class="active">
                    <a class="accordion-toggle menu-open" href="dashboard.php">
                        <span class="fa fa-dashboard"></span>
                        <span href="dashboard.php" class="sidebar-title">Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        ...
                        <span class="sidebar-title">SEND MESSAGES</span>
                ...
                <li>
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="sms-group.php">
                                <span class="glyphicon glyphicon-tags"></span> Groups </a>
                        </li>
                        <li>
                            <a href="sms-import-contacts.php">
                                <span class="glyphicon glyphicon-tags"></span> Import From Excel </a>
                        </li>
                        <li>
                            <a href="sms-contact.php">
                ...
                <li>
                    <a href="sms-history.php">
                        <span class="fa fa-book"></span>
                        <span class="sidebar-title">SMS History</span>
                    </a>
                </li>

                <li>
                    <a href="register-sender-id.php">
                        <span class="fa fa-book"></span>
                        <span class="sidebar-title">Register Sender ID</span>
                    </a>
                </li>
        ...
        <!--        <li>
                    <a class="accordion-toggle" href="#">
                        ...
                        <span class="sidebar-title">SMS GROUPS & CONTACTS</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            ...
                            <ul class="nav sub-nav">
                                <li>
                                    <a href="new_contact.html">
                                        New Contact </a>
                                </li>
                                <li>
                                    <a href="sidebar-left-fixed.html">
                                        Import Contact From Excel </a>
                                </li>
                                <li>
                ...
                <li>
                    <a class="accordion-toggle" href="#">
                        ...
                        <span class="sidebar-title">SMS GROUPS</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="create_group.html">
                                <span class="glyphicon glyphicon-book"></span>  Create Group </a>
                        </li>
                        <li>
                            <a href="new_contact.html">
                                <span class="glyphicon glyphicon-modal-window"></span> New Contact </a>
                        </li>
                        <li>
                            <a href="management-tools-dock.html">
                                <span class="glyphicon glyphicon-equalizer"></span> Import Contact From Excel </a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="sender_id.html">
                        <span class="fa fa-envelope-o"></span>
                        <span class="sidebar-title">SENDER ID</span>
                    </a>
                </li>
                <li>
                    <a href="sms_template.html">
                        <span class="fa fa-envelope-o"></span>
                        <span class="sidebar-title">SMS TEMPLATE</span>
                    </a>
                </li>
                <li>
                    <a class="accordion-toggle" href="#">
